sap.ui.define([
		...
		return BaseObject.extend("masteruno.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias masteruno.model.ListSelector
			 */
			 ...
			 * @return {masteruno.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
