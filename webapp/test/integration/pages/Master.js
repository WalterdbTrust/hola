							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("VEHICLE_VIEW_GROUP", {
											VIN : sCurrentId
										});
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "VEHICLE_VIEW_GROUP (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'VEHICLE_VIEW_GROUP (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all VEHICLE_VIEW_GROUP to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "VEHICLE_VIEW_GROUP (" + iExpectedLength + ")"}),
									success : function () {
